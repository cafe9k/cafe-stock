 ...
 * 输出: 无（示例代码文件）
 * 职责: 渲染进程工具层示例文件，展示announcementClassifier的使用方法
 *
 * ⚠️ 更新提醒：修改此文件后，请更新 src/utils/README.md
 */

import { classifyAnnouncement, classifyAnnouncements, getCategoryStats, getCategoryColor, getCategoryIcon } from "./announcementClassifier";
