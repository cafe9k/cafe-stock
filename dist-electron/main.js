...
import { getAnnouncements, getLatestAnnDate, getOldestAnnDate, hasDataInDateRange, insertAnnouncements, countAnnouncements, getAnnouncementsGroupedByStock, getAnnouncementsByStock, countStocksWithAnnouncements, searchAnnouncementsGroupedByStock, countSearchedStocksWithAnnouncements, addFavoriteStock, removeFavoriteStock, isFavoriteStock, getAllFavoriteStocks, countFavoriteStocks, getFavoriteStocksAnnouncementsGrouped, countFavoriteStocksWithAnnouncements, upsertTop10Holders, getTop10HoldersByStock, hasTop10HoldersData, getStocksWithTop10Holders, countStocksWithTop10Holders, deleteTop10HoldersByStock, } from "./db.js";
...
function setupIPC() {
    ...
    ipcMain.handle("get-announcements-grouped", async (_event, page, pageSize, startDate, endDate, market) => {
        try {
            ...
            console.log(`[IPC] get-announcements-grouped: page=${page}, offset=${offset}, items=${items.length}, total=${total}, dateRange=${startDate}-${endDate}, market=${market}`);
            return {
                items,
                total,
                page,
    ...
    ipcMain.handle("search-announcements-grouped", async (_event, keyword, page, pageSize, startDate, endDate, market) => {
        try {
            ...
            console.log(`[IPC] search-announcements-grouped: keyword=${keyword}, page=${page}, items=${items.length}, total=${total}, dateRange=${startDate}-${endDate}, market=${market}`);
            return {
                items,
                total,
                page,
